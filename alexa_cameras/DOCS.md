...
- **What Alexa actually receives.** Every camera is delivered as **H.264 video + AAC audio**
  ...
  15 fps** (Level 3.1); a higher-res or higher-fps source is downscaled to that.
